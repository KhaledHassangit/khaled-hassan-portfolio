...
const icons = [FolderTree, Component, Database, GitBranch, Layers];
    ...
    <section id="architecture" className="section-padding" ref={ref}>
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <p className="text-sm font-mono text-primary mb-3">{t.architecture.label}</p>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {t.architecture.heading1} <span className="text-primary">{t.architecture.heading2}</span>
          </h2>
          <p className="text-muted-foreground max-w-xl text-lg">{t.architecture.desc}</p>
        </motion.div>
